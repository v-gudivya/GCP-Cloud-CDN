...
To access the terraform script for Log Setup [Click here](https://github.com/v-gudivya/GCP-Cloud-CDN/blob/main/GCPCloudCDN_CCPLogsSetup/GCPCloudCDNLogSetup.tf).
